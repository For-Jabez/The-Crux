...
**The Crux Lady in the Woods Edition v1.1**  
[Direct download: The_Crux_LITW_Edition_v1.1.rar](https://github.com/For-Jabez/The-Crux/releases/download/The_Crux_LITW_Edition_v1.1/The_Crux_LITW_Edition_v1.1.rar)
...
Full step-by-step verification instructions are inside the package (Manual_Verification_Guide.html) after you verify the archive hash.

This is the external-derivation seed. No system can verify itself.
